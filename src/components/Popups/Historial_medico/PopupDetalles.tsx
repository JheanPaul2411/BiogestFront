...
const PopupDetallesTabla: React.FC<PropsPopupEditarCita> = ({
    selectedUser,
    onClose,
}) => {
    ...
    return (
        <Modal onClose={onClose} size={"5xl"} popup show={true}>
            <Modal.Header />
            <Modal.Body className="flex flex-col items-center">
                <div>
                    <p>Citas del paciente {selectedUser.nombre} {selectedUser.apellido}</p>
